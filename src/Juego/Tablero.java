...
import Juego.LogicaTablero;
import Juego.Personaje;
import Juego.Registros;
...
boolean ModoTutorial;
    ...
    int JugadorHeroe = -1;
    LogicaTablero ControladorTablero;
   ArrayList<Registros> Todoslos_Logs;
    ...
    public Tablero(int UserIndex, ArrayList<Usuario> UsuariosObtenidos, ArrayList<Registros> Todoslos_Logs_A) {
       
        G_UserIndex = UserIndex;
        Todos_Usuarios = UsuariosObtenidos;
        ControladorTablero = new LogicaTablero(true);
        ...
        String[] buttons = {"Héroe", "Villano"};
        int returnValue = JOptionPane.showOptionDialog(null, "Bandos: ", "Elija su bando",
    ...
    for (int i = 0; i < UsuariosObtenidos.size(); i++) {
        ...
        String input = (String) JOptionPane.showInputDialog(null, "Escoja al segundo jugador",
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 20, -1, -1));
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       String[] buttons = {"Si", "No"};
        int returnValue = JOptionPane.showOptionDialog(null, "Seguro que quiere rendirse?", "Elija una opción",
                JOptionPane.WARNING_MESSAGE, 0, null, buttons, buttons[0]);
        ...
        if(returnValue==0){     
           ...
           DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");
                ...
                this.Todos_Usuarios.get(this.JugadorHeroe).setPuntos(PuntosdelJugador + 3);
                 ...
                 Todoslos_Logs.add(new Registros(this.Todos_Usuarios.get(this.JugadorHeroe).getUser(),
                ...
                MenuPrincipal ObjetoMenuPrincipal = new MenuPrincipal(G_UserIndex, this.Todos_Usuarios, this.Todoslos_Logs);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
          ...
          String[] buttons = {"Si", "No"};
        int returnValue = JOptionPane.showOptionDialog(null, "Seguro que quiere rendirse?", "Elija una Opcion",
                JOptionPane.WARNING_MESSAGE, 0, null, buttons, buttons[0]);
        ...
        if(returnValue==0){
            ...
            DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");
                ...
                this.Todos_Usuarios.get(this.JugadorVillano).setPuntos(PuntosdelJugador + 3);
                  ...
                  Todoslos_Logs.add(new Registros(this.Todos_Usuarios.get(this.JugadorVillano).getUser(),
        ...
        for (int i = 0; i < MatrizTablero.length; i++) {
            for (int j = 0; j < MatrizTablero[0].length; j++) {
                ...
                if (MatrizTablero[i][j] == null) {
                    ...
                    jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Tablero/blanco.png")));
                } else if (MatrizTablero[i][j].getRango() == -1) {
                    jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Tablero/ZPH.jpg")));
                } else {

                    if (MatrizTablero[i][j].isHeroe_Villano()) {
                        if (ControladorTablero.isTurnoHeroe()) {
                            jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Fichas/Heroes/" + MatrizTablero[i][j].getID() + ".jpg")));
                        } else {
                            jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Tablero/azulclaro.jpg")));
                        }

                    } else {

                        if ((!ControladorTablero.isTurnoHeroe())) {
                            jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Fichas/Villanos/" + MatrizTablero[i][j].getID() + ".jpg")));
                        } else {
                            jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Tablero/morado.png")));
                        }
        ...
        for (int i = 0; i < MatrizHeroes.length; i++) {
            for (int j = 0; j < MatrizHeroes[0].length; j++) {
                ...
                if (MatrizHeroes[i][j].isVivo()) {
                    ...
                    jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Fichas/Heroes/" + MatrizHeroes[i][j].getID() + ".jpg")));
                }
        ...
        for (int i = 0; i < MatrizVillano.length; i++) {
            for (int j = 0; j < MatrizVillano[0].length; j++) {
                ...
                if (MatrizVillano[i][j].isVivo()) {
                    ...
                    jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Fichas/Villanos/" + MatrizVillano[i][j].getID() + ".jpg")));
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tablero(-1, null,null).setVisible(true);
            }
        });
    }
    ...
    class fondoInicio extends JPanel{
        ...
        public void paint(Graphics g){
                fondo=new ImageIcon(getClass().getResource("/Imagenes/Tablero/Tablero.jpeg")).getImage();
